...
# mergesorted: merge sorted iterators
...
"""
Merge sorted iterators removing dublicates. Comparison is done using `lt` option
that defaults to `isless` function.
"""
